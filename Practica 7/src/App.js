...
const initialStudents = [
  { id: 1, name: "Сопов Матвей Андреевич", visits: ["н", "2", "н", "н", "н", "н"] },
  { id: 2, name: "Бикбаев Ильгис Русланович", visits: ["н", "5", "оп", "п", "н", "н"] },
  { id: 3, name: "Сигачева Дарья Сергеевна", visits: ["н", "5", "п", "н", "н", "н"] },
  { id: 4, name: "Булатов Михаил Владимирович", visits: ["н", "5", "п", "н", "н", "н"] },
];
...
function StudentList({ students, setStudents }) {
  ...
  return (
    <div style={{ maxWidth: 600, margin: "30px auto", background: "#ffffff", borderRadius, boxShadow: shadow, padding: 32 }}>
      <h2 style={{ color: mainColor, marginBottom: 24, textAlign: "center", fontFamily: "Arial, sans-serif" }}>Журнал группы</h2>
      <input
        placeholder="Фильтр по ФИО"
        value={filter}
        onChange={e => setFilter(e.target.value)}
        style={{ marginBottom: 20, padding: 10, borderRadius, border: `1px solid ${mainColor}33`, outline: "none", width: "100%", fontSize: 16 }}
      />
      <button
        onClick={addStudent}
        style={{
          background: `linear-gradient(90deg, ${mainColor}, #0d47a1)`,
          color: "#fff",
          border: "none",
          borderRadius,
          padding: "10px 20px",
      ...
      <ul style={{ listStyle: "none", padding: 0, margin: 0, marginTop: 20 }}>
        ...
        {filtered.map(student => (
          <li
            key={student.id}
            style={{
              background: selected === student.id ? "#e3f0fc" : "#f9f9f9",
              margin: "10px 0",
              padding: "16px 18px",
          ...
          >
            ...
            <button
              ...
              onMouseOver={e => { e.currentTarget.style.background = "#d32f2f"; e.currentTarget.style.transform = "scale(1.05)"; }}
              onMouseOut={e => { e.currentTarget.style.background = "#ff5252"; e.currentTarget.style.transform = "scale(1)"; }}
            >
              Удалить
            </button>
          </li>
